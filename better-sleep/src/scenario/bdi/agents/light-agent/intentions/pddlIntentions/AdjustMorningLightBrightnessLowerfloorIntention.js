...
class AdjustMorningLightBrightnessLowerfloorIntention extends pddlActionIntention {
    static parameters = [
    ...
    static effect = [
        ...
        ["morning-brightness", "lower_floor-main_light"],
    ];
...
module.exports = AdjustMorningLightBrightnessLowerfloorIntention;
