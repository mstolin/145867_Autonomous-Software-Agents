...
class AdjustAfternoonLightTemperaturesecond_floorIntention extends pddlActionIntention {
    static parameters = [
...
module.exports = AdjustAfternoonLightTemperaturesecond_floorIntention;
